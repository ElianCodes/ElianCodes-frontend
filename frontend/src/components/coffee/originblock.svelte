<section class="block-origin" id="origin">
    <div class="relative">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden" data-aos="fade-up">
                <div class="absolute inset-0" data-aos="fade-up">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-green-800 to-green-700 mix-blend-multiply"></div>
                </div>
                <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                    <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl" data-aos="fade-up">
                        <span class="block text-white">The origin of Elian.Coffee</span>
                        <!-- <span class="block text-green-200">customer support</span> -->
                    </h1>
                    <p class="mt-6 max-w-lg mx-auto text-center text-xl text-green-200 sm:max-w-3xl" data-aos="fade-up">
